...
const AttackOfTheClonesManual: FC = () => {
  return (
    <Manual stepName={"attack-of-the-clones"} title={"👯‍♀️ Атака клонов"} error={"Слишком мало подов, надо больше."}>
      <h2>Опять работа?</h2>
      <p>
        <Tutorial theme={"k9s"} chapter={"logs"}>
          Бродя по логам
        </Tutorial>{" "}
        <b>API</b> мы поняли, что есть нехватка оперативной памяти. Увеличивать ресурсы за счет лимитов уже нельзя, увы.
        Но есть еще один способ. Горизонтально масштабирование. Разработчики контейнеров обещали, конечно же, корректную
        работы своих продуктов в таком стиле.
      </p>
      <p>
        <Tutorial theme={"k9s"} chapter={"logs"}>
          Прогуляемся
